	...
	<div class="row">
		<div class="col-12">
			<div class="card">
				<!-- /.card-header -->
				<div class="card-body">
					<form action="{{ url('SuratAhliWaris/'.$id_noSurat) }}" target="_blank" id="suratahliwariscreate" method="post" role="form">
						@csrf
						<div class="card-body">    
               ...
               <label>Keterangan Surat Ahli Waris:</label>
                <textarea name="keterangan_surat" class="form-control"></textarea>
              </div>
...
<script type="text/javascript">
    ...
    $('#suratahliwariscreate').validate({
        ...
        messages:{
            ...
            keterangan_surat : {
                required: "Keterangan Surat tidak boleh kosong"
            }, 
