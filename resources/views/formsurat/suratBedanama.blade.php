	...
	<div class="row">
		<div class="col-12">
			<div class="card">
				<!-- /.card-header -->
				<div class="card-body">
					<form action="{{ url('suratbedanama/'.$id_noSurat) }}" target="_blank" id="suratbedanamacreate" method="post" role="form">
						@csrf
						<div class="card-body">    
              ...
              <textarea name="keterangan_kesalahan" class="form-control"></textarea>   
               </div>     
...
<script type="text/javascript">
    ...
    $('#suratbedanamacreate').validate({
        rules: {
            // id_kk sesuaikan dengan name yang ada pada input
            nik : {
                required:true
            },
            keterangan_kesalahan : {
                required:true
            },
