	...
	<div class="row">
		<div class="col-12">
			<div class="card">
				<!-- /.card-header -->
				<div class="card-body">
					<form action="{{ url('SuratDispensasiWaktuPernikahan/'.$id_noSurat) }}" target="_blank" id="suratdispensasinikahcreate" method="post" role="form">
						@csrf
						<div class="card-body">
              ...
              <textarea name="keterangan" class="form-control"></textarea>   
               ...
               <div class="form-group">
                ...
                <div class="input-group">
                  ...
                  <input type="text" class="form-control" name="tanggal_nikah" id="datenikah">
                </div>   
              <div class="form-group">
                <label>Sebagai Calon:</label>
                <input type="text" class="form-control" name="sebagai1">
              </div>    
  			     <div class="form-group">
                 ...
                 <div class="form-group">
                <label>Sebagai Calon:</label>
                <input type="text" class="form-control" name="sebagai2">
              </div>
               <div class="form-group">
                <label>Nama:</label>
               ...
               <div class="form-group">
                ...
                <div class="input-group">
                  ...
                  <input type="text" class="form-control" name="tanggal_lahir" id="datelahir">
                </div>
                 <div class="form-group">
...
<script type="text/javascript">
    ...
    $('#suratdomisilicreate').validate({
        ...
        messages:{
            ...
            tanggal_nikah : {
                required: "Tanggal nikah tidak boleh kosong"
            },
            sebagai1 : {
