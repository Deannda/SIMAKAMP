	...
	<div class="row">
		<div class="col-12">
			<div class="card">
				<!-- /.card-header -->
				<div class="card-body">
					<form action="{{ url('suratdomisili/'.$id_noSurat) }}" target="_blank" id="suratdomisilicreate" method="post" role="form">
						@csrf
						<div class="card-body">    
                 ...
                 <!--  <div class="form-group">
                <label>Berdomisili Sejak:</label>
                <div class="input-group">
                  <div class="input-group-prepend">
                    <span class="input-group-text"><i class="far fa-calendar-alt"></i></span>
                  </div>
                  <input type="text" class="form-control" name="tanggal_domisili" id="datedomisili">
                </div>     -->   
