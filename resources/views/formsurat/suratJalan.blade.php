	...
	<div class="row">
		<div class="col-12">
			<div class="card">
				<!-- /.card-header -->
				<div class="card-body">
					<form action="{{ url('suratjalan/'.$id_noSurat) }}" target="_blank" id="suratjalancreate" method="post" role="form">
						@csrf
						<div class="card-body">    
                  ...
                  <select name="nik" class="form-control select2" style="width: 100%;">
                   ...
                   @endforeach
							...
							<div class="form-group">
								...
								<input type="text" class="form-control" name="desakel">
							</div>
							<div class="form-group">
              ...
              <div class="form-group">
                ...
                <input type="text" class="form-control" name="kabkot">
              </div>
                <div class="form-group">
              ...
              <div class="form-group">
                ...
                <input type="text" class="form-control" name="jumpe">
              </div>
               <div class="form-group">
                <label>Keterangan Pengikut:</label>
               <textarea class="form-control" name="ket_pengikut"></textarea>
              </div>          
...
<script type="text/javascript">
    ...
    $('#suratjalancreate').validate({
        ...
        messages:{
            ...
            kabkot : {
                required: "Kabupaten boleh kosong"
            },
            prov : {
            ...
            jumpe : {
                required: "Jumlah Pengikut tidak boleh kosong"
            },
            ket_pengikut : {
                required: "Keterangan Pengikut tidak boleh kosong"
            },                               
        },
