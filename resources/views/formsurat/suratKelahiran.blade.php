...
<section class="content-header">
  <div class="container-fluid">
    <div class="row mb-2">
      <div class="col-sm-6">
        <h1>Surat Pernyataan Kelahiran</h1>
    </div>
	...
	<div class="row">
		<div class="col-12">
			<div class="card">
				<!-- /.card-header -->
				<div class="card-body">
					<form action="{{ url('SuratPernyataanKelahiran/'.$id_noSurat) }}" target="_blank" id="suratkelahirancreate" method="post" role="form">
						@csrf
						<div class="card-body">    
                ...
                <div class="input-group">
                  ...
                  <input type="text" class="form-control" name="tanggal_lahir" id="datekelahiran">
                </div>
                <div class="form-group">
