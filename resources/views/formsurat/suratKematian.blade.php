	...
	<div class="row">
		<div class="col-12">
			<div class="card">
				<!-- /.card-header -->
				<div class="card-body">
					<form action="{{ url('suratkematian/'.$id_noSurat) }}" target="_blank" id="suratkematiancreate" method="post" role="form">
						@csrf
						<div class="card-body">    
              ...
              <div class="form-group">
                ...
                <select name="pasangan" class="form-control select2" style="width: 100%;">
                 <option value="">Pilih NIK</option>
                 @foreach ($penduduk as $data)
                 <option value="{{$data->nik}}">{{$data->nik}}|{{$data->nama}}</option>
                 @endforeach
               ...
               <div class="form-group">
                ...
                <input type="text" class="form-control" name="tanggal_kematian" id="datekematian">
              </div>
            </div>
            <div class="form-group">
    ...
    $('#suratkematiancreate').validate({
      rules: {
        ...
        messages:{
            ...
            sebab : {
              required: "Sebab tidak boleh kosong"
            },        
          },
