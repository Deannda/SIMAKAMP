...
<section class="content-header">
  <div class="container-fluid">
    <div class="row mb-2">
      <div class="col-sm-6">
        <h1>Surat Permohonan Izin Hiburan/Keramaian</h1>
    </div>
	...
	<div class="row">
		<div class="col-12">
			<div class="card">
				<!-- /.card-header -->
				<div class="card-body">
					<form action="{{ url('suratizinkeramaian/'.$id_noSurat) }}" target="_blank" id="suratkeramaiancreate" method="post" role="form">
						@csrf
						<div class="card-body">    
...
<script type="text/javascript">
    ...
    $('#suratkeramaiancreate').validate({
        ...
        messages:{
            ...
            haritanggal : {
                required: "Hari/Tanggal tidak boleh kosong"
            },
            acara : {
