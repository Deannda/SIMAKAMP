	...
	<div class="row">
		<div class="col-12">
			<div class="card">
				<!-- /.card-header -->
				<div class="card-body">
					<form action="{{ url('SuratPengajuanKKN/'.$id_noSurat) }}" target="_blank" id="suratkkncreate" method="post" role="form">
						@csrf
						<div class="card-body">   
             ...
             <div class="form-group">
               ...
               <textarea name="proker" class="form-control"></textarea>
              </div> 
                <div class="form-group">
               <label>Tema Penelitian:</label>
               <textarea name="tema" class="form-control"></textarea>
              </div>    
...
<script type="text/javascript">
    ...
    $('#suratkkncreate').validate({
        ...
        messages:{
            ...
            di : {
                required: "Ditidak boleh kosong"
            }, 
            proker : {
                required: "Program Kerja tidak boleh kosong"
            }, 
            tema : {
                required: "Tema Penelitian tidak boleh kosong"
            }, 
