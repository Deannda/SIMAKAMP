...
<section class="content-header">
  <div class="container-fluid">
    <div class="row mb-2">
      <div class="col-sm-6">
        <h1>Surat Rekomendasi Pindah Nikah</h1>
    </div>
	...
	<div class="row">
		<div class="col-12">
			<div class="card">
				<!-- /.card-header -->
				<div class="card-body">
					<form action="{{ url('SuratRekomendasiPindahNikah/'.$id_noSurat) }}" target="_blank" id="suratpindahnikahcreate" method="post" role="form">
						@csrf
						<div class="card-body">    
  			   <div class="form-group">
                  ...
                  <select name="nik" class="form-control select2" style="width: 100%;">
                   ...
                   @endforeach
							...
							<div class="form-group">
								<label>Kepada Penghulu Kampung:</label>
...
<script type="text/javascript">
    ...
    $('#suratpindahnikahcreate').validate({
        rules: {
