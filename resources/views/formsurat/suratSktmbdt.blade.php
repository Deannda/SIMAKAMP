	...
	<div class="row">
		<div class="col-12">
			<div class="card">
				<!-- /.card-header -->
				<div class="card-body">
					<form action="{{ url('SKTMBDT/'.$id_noSurat) }}" target="_blank" id="suratsktmcreate" method="post" role="form">
						@csrf
						<div class="card-body">    
            ...
            <!--   <div class="form-group">
                <label>Petugas Fasilitator:</label>
