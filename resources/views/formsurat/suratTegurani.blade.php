	...
	<div class="row">
		<div class="col-12">
			<div class="card">
				<!-- /.card-header -->
				<div class="card-body">
					<form action="{{ url('SuratTeguranI/'.$id_noSurat) }}" target="_blank" id="suratteguranicreate" method="post" role="form">
						@csrf
						<div class="card-body">    
              ...
              <div class="form-group">
               <label>Dasar Teguran:</label>
               <textarea name="dasar_teguran" class="form-control" ></textarea>
              </div> 
              <div class="form-group">
               <label>Isi Teguran I:</label>
               <textarea name="isi_teguran" class="form-control" ></textarea>
              </div>    
...
<script type="text/javascript">
    ...
    $('#suratteguranicreate').validate({
        ...
        messages:{
            ...
            dasar_teguran : {
                required: "Dasar Teguran tidak boleh kosong"
            },
            isi_teguran : {
                required: "Isi Teguran tidak boleh kosong"
            },
