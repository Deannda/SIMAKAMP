		...
		<table>
			...
			<tbody >
				...
				<tr>
					...
					<td width="250"><font size="13" face="Times New Roman"><u><strong>SURAT KETERANGAN DOMISILI</strong></u></font></td>
				</tr>
				<tr>
					<td width="185">
					</td>
					...
					<tr>
						...
						<td width="" align="justify"><font size="13" face="Times New Roman">Kepala Desa {{ ucfirst($desa[0]->kabupaten[0]->status)}} {{ ucfirst($desa[0]->nama_desa) }} Kecamatan {{ ucfirst($desa[0]->kecamatan[0]->nama_kecamatan) }} Kabupaten {{ ucfirst($desa[0]->kabupaten[0]->nama_kabupaten)}} dengan ini menerangkan bahwa:
					...
					<tr height="0">
						...
						<td width="" align="justify">
							...
							<font size="13" face="Times New Roman">Nama tersebut diatas adalah benar penduduk {{ ucfirst($desa[0]->kabupaten[0]->status)}} {{ ucfirst($desa[0]->nama_desa) }} Kecamatan {{ ucfirst($desa[0]->kecamatan[0]->nama_kecamatan) }} Kabupaten {{ ucfirst($desa[0]->kabupaten[0]->nama_kabupaten)}}, dan telah Berdomisili di {{ ucfirst($desa[0]->kabupaten[0]->status)}} {{ ucfirst($desa[0]->nama_desa) }} Kecamatan {{ ucfirst($desa[0]->kecamatan[0]->nama_kecamatan) }} Kabupaten {{ ucfirst($desa[0]->kabupaten[0]->nama_kabupaten)}}. <!-- sejak taggal {{ ucwords($datasurat[0]->tanggal_domisili) }}  -->
					...
					<tr>
						...
						<td width="" align="justify">
							...
							<font size="13" face="Times New Roman">Demikian Surat Keterangan ini kami buat dengan sebenarnya, untuk dapat dipergunakan dengan sebagaimana mestinya.
